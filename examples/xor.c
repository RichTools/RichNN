...
int main(int argc, char** argv) 
{
  ...
  int individual_training_example = 2;

  NeuralNetwork* XorNetwork = (NeuralNetwork*)malloc(sizeof(NeuralNetwork));
  init_network(XorNetwork, layer_sizes, layer_count, individual_training_example, train_count);
  
  NeuralNetwork* gradients = (NeuralNetwork*)malloc(sizeof(NeuralNetwork));
  init_network(gradients, layer_sizes, layer_count, individual_training_example, train_count);
